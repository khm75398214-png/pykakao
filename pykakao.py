...
class kakaotalk:
    ...
    def auth(self, email, password, comp_name, device_uuid, x_vc, once=False, forced=False):
        ...
        Parameters:
            email : kimgaon141414@gmail.com. [type str]
            password : kimgaon14. [type str]
            comp_name : DESKTOP-S5MTOLV. [type str]
            device_uuid : device_uuid. [type str]
            x_vc : Token that generated by email. (IDK How to generate this token) [type str]
                   16 characters hexadecimal string
            once : True. [type bool]
            forced : True. [type bool]
        Returns:
